                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-6 col-xs-12">
                            <div class="view-mode pull-left">
                               <strong><a href="{{ url('cua-hang') }}">Bỏ lọc</a></strong>
                            </div>
                            <form method ="get" action="{{url('cua-hang')}}">
                                <div class="filters-toolbar-item text-right pull-right filter-fiel"><label for="SortBy" class="label-sortby">Sắp xếp:</label>
                            ...
                            <div class="filters-toolbar-item hidden">
                                <span class="filters-toolbar-count">Hiển thị {{ $products->firstItem() }} đến {{ $products->lastItem() }} của tổng {{$products->total()}} sản phẩm</span></span>
                            </div>
                            
                        </div>
                        <div class="col-md-4 col-sm-6 hidden-xs">
                            <span class="product-count">Hiển thị {{ $products->firstItem() }} đến {{ $products->lastItem() }} của tổng {{$products->total()}} sản phẩm</span></span>
                        </div>
                    </div>
                </div>
            </div>
