...
class AdminCategoryController extends Controller
{
    ...
    public function store(CategoryRequest $request)
    {
       ...
       //validate data
        ...
        //image tron
        if($request->hasFile('image_tron')) {
            //kiem tra va tao thu muc
            checkDirectory("categories/tron");
            //upload file xong lay ten luu vao database
            $category->image_tron = uploadFile($request, 'image_tron', public_path('uploads/categories/tron'),$request->input('title'));
        }
        $category->save();
    ...
    public function destroy($id)
    {
        ...
        //delete image tron
        if($category -> image_tron){
            $delete_image=public_path().'/uploads/categories/tron'.$category-> image_tron;
             unlink($delete_image);
        }
