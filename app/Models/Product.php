...
class Product extends Model
{
    ...
    protected $fillable = ["title","description","price","amount","discount","discount_start_date","discount_end_date","created_by","category_id","brand_id","product_code","featured","is_active","new","additional","noi_bat","ship"];
